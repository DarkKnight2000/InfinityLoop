...
level12 = Game
    ...
    crctConfig = [3, 11, 9, 7, 15, 13, 6, 14, 12] ,
    rows = 3,
    cols = 3,
    posx = 1,
    posy = 1,
...
level32 = Game
    ...
    crctConfig = [3, 10, 11, 11, 9, 7, 10, 13, 5, 5, 7, 11, 15, 14, 13, 5, 5, 7, 10, 13, 6, 14, 14, 10, 12] ,
    rows = 5,
    cols = 5,
    posx = 1,
    posy = 1,
